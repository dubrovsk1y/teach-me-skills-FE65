...
const Information = () => {
    ...
    const TEXT_2 = 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Enim laudantium ipsam, assumenda sequi sint ipsa debitis esse inventore cupiditate cumque nesciunt. Libero, optio eius. Quidem culpa saepe qui quasi tempora?'
    const TEXT_3 = 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae ad quisquam unde error porro corporis! Aliquid veniam asperiores, iste optio ex commodi facilis vero vel, dolorum itaque quia autem consequuntur.'
        ...
        <div className="information">
            <div className="information__container _container">
                ...
                <div className="information__tabs">
                    <Tab onClick={()=> onTabClick('TAB_1', TEXT_1)} className={classNames('tab', {['_active']: activeTab === 'TAB_1'})} text="Tab1"></Tab>
                    <Tab onClick={()=> onTabClick('TAB_2', TEXT_2)} className={classNames('tab', {['_active']: activeTab === 'TAB_2'})} text="Tab2"></Tab>
                    <Tab onClick={()=> onTabClick('TAB_3', TEXT_3)} className={classNames('tab', {['_active']: activeTab === 'TAB_3'})} text="Tab3"></Tab>
                </div>
